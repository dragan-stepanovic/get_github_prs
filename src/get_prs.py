...
def main():
    ...
    print(in_green(f'File saved to {save_to_file(anonymized_prs, "GitHub_PRs")}'))
    print(in_green(f'File saved to {save_to_file(usernames_to_substitutes, "Username_substitutes")}'))
